...
const GOALS: Goal[] = ['pain_management', 'strength', 'mobility', 'posture', 'endurance'];
          ...
          >
            ...
            {expandedSections.bodyArea && (
              <View style={styles.filterButtons}>
                <TouchableOpacity
                  style={[styles.filterButton, showAllBodyAreas && styles.filterButtonActive]}
            ...
            {expandedSections.goal && (
              <View style={styles.filterButtons}>
                <TouchableOpacity
                  style={[styles.filterButton, showAllGoals && styles.filterButtonActive]}
                  onPress={() => setAllGoals(true)}
                >
                  <ThemedText
                    style={[styles.filterButtonText, showAllGoals && styles.filterButtonTextActive]}
                  >
                    All
                  </ThemedText>
                </TouchableOpacity>
            ...
            {expandedSections.equipment && (
              <View style={styles.filterButtons}>
                <TouchableOpacity
                  style={[styles.filterButton, showAllEquipment && styles.filterButtonActive]}
